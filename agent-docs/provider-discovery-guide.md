...
Full design docs are in [docs/designs/slo-provider/](../docs/designs/slo-provider/).
...
- Top-level plan: [docs/designs/slo-provider/2026-03-04-slo-provider-plan.md](../docs/designs/slo-provider/2026-03-04-slo-provider-plan.md)
- Stage 1 (Definitions CRUD): [docs/designs/slo-provider/1-slo-definitions-crud/](../docs/designs/slo-provider/1-slo-definitions-crud/)
- Stage 2 (Reports CRUD): [docs/designs/slo-provider/2-reports-crud/](../docs/designs/slo-provider/2-reports-crud/)
- Stage 3 (Definitions Status): [docs/designs/slo-provider/3-definitions-status/](../docs/designs/slo-provider/3-definitions-status/)
- Stage 4 (Reports Status): [docs/designs/slo-provider/4-reports-status/](../docs/designs/slo-provider/4-reports-status/)
